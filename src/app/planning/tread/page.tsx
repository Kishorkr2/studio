...
import { Spline, ClipboardList, Factory, Scale } from 'lucide-react';
...
export default function TreadPlanningPage() {
    ...
    <div className="space-y-6">
        <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">
                Tread Production Plan
            </h1>
            <p className="text-muted-foreground">
                Plan and manage tread production requirements.
            </p>
        </div>
