...
function AdminDashboard({ operators, machines, productionPlan, productionLogs }: { operators: Operator[], machines: Machine[], productionPlan: ProductionPlanItem[], productionLogs: ReportDataRow[] }) {
...
export default function AdminPage() {
  ...
  const managementSections = [
     {
      value: 'dashboard',
      title: 'Dashboard',
      description: 'Live overview of factory performance',
      icon: LayoutDashboard,
      content: <AdminDashboard operators={operators} machines={machines} productionPlan={productionPlan} productionLogs={productionLogs} />
    },
    {
      value: 'users',
    ...
    },
    {
      value: 'operators',
      title: 'Operators',
      description: 'Manage operator profiles and skills',
      icon: UserPlus,
      content: (
        <Card>
          <CardHeader>
    ...
    },
    {
      value: 'tbm',
      title: 'TBM Machines',
      description: 'Manage TBM machine inventory',
      icon: Cog,
      content: (
        <MachineManagement 
    ...
    },
    {
      ...
      description: 'Manage curing press inventory',
      icon: DatabaseZap,
      content: (
        <MachineManagement 
  ...
  return (
    <div className="space-y-6">
      ...
      <Accordion type="multiple" className="w-full space-y-4" defaultValue={['dashboard']}>
